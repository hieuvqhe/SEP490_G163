...
import { ContractManagement } from '../contents';

const ManagerContractManagementPage = () => {
  ...
  return (
    <Sidebar open={sidebarOpen} onClose={closeSidebar}>
      ...
      <div className="min-h-screen bg-[#09090b] py-12 px-4 pt-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-lg">Danh sách hợp đồng và trạng thái xử lý.</p>
          </div>
...
export default ManagerContractManagementPage;
