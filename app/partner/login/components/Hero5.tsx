...
export default function Hero5() {
  ...
  return (
    <div className="font-sans">
      ...
      <div className="min-h-screen flex flex-col items-center bg-bg-black dark:bg-black py-8 sm:py-12 px-4 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-200 dark:text-white mt-4 sm:mt-6 mb-4 sm:mb-6 leading-tight transition-colors duration-300">
              Bạn có rạp, chúng tôi có giải pháp.
              <br className="hidden sm:block" />
              <span className="sm:hidden"> </span>{" "}
              <FlipWords words={["Nhanh Chóng", "An Toàn", "Tiện Lợi"]} />
            </h1>

            <p className="text-base sm:text-lg text-gray-400 dark:text-gray-300 max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed transition-colors duration-300">
              TicketXpress là nền tảng quản lý rạp chiếu phim toàn diện, giúp
              các đối tác rạp tối ưu hóa vận hành, tự động hóa quy trình đặt vé,
              và nâng cao trải nghiệm khán giả.
            </p>
