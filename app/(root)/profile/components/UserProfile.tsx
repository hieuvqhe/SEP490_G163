              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 transition-all duration-300">
                <div className="flex items-center justify-between">
                  ...
                  {isEditing ? (
                    ...
                    <span className="text-white font-semibold">
                      {getUserData()?.phone || "Chưa cập nhật"}
                    </span>
                  )}
                </div>
              </div>
          ...
          {isEditing ? (
            ...
            <>
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold rounded-2xl hover:from-purple-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                Chỉnh sửa hồ sơ
              </button>
              <button
